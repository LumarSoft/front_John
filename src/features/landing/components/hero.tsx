...
export function Hero() {
  return (
    ...
    >
      <div className="container pt-[60px] pb-[80px]">
        <div>
          ...
          <div className="mt-8 border border-line-2 rounded-2xl p-6 grid grid-cols-[1fr_1fr_1fr_auto] gap-6 items-center bg-[linear-gradient(180deg,rgba(232,168,32,0.05)_0%,transparent_100%)] max-[720px]:grid-cols-[1fr_1fr] max-[720px]:gap-[18px]">
            <div>
