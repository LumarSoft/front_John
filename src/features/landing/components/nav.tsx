...
export function Nav() {
  ...
  return (
    <>
      <header>
        <nav className="sticky top-0 z-[100] border-b border-line-2 bg-ink">
          <div className="container flex items-center justify-between h-[72px] gap-6">
            <Link href="/" className="flex items-center gap-[14px] shrink-0">
              <div className="w-[42px] h-[42px] border-[1.5px] border-amber flex items-center justify-center font-bold text-[15px] text-amber tracking-[0.08em] shrink-0">
                JP
              </div>
              <div>
            ...
            <div className="flex gap-7 items-center text-[13.5px] text-cream-2 max-[760px]:hidden">
              <Link
                href="/coberturas"
                className="py-[6px] border-b border-transparent transition-colors hover:text-amber hover:border-amber"
              >
                Coberturas
              </Link>
              <a
            ...
            <a
              ...
              className="text-[14px] text-cream tracking-[-0.01em] font-medium shrink-0 text-right max-[760px]:hidden"
            >
      ...
      >
        <div className="flex items-center justify-between h-[72px] border-b border-line-2 shrink-0">
          ...
          <button
            className="bg-transparent border-none text-cream-2 p-[10px] flex items-center justify-center transition-colors hover:text-cream"
            onClick={close}
        ...
        <div
          className={`flex gap-3 mt-8 transition-[transform] duration-[380ms] ease-[cubic-bezier(0.16,1,0.3,1)] delay-[100ms] ${open ? 'translate-y-0' : 'translate-y-3'}`}
        >
          <a
            href="tel:+541148150099"
            onClick={close}
            className="flex-1 flex items-center justify-center gap-2 h-[52px] border border-line-2 text-[13.5px] font-semibold text-cream-2 tracking-[-0.01em] transition-[border-color,color] [-webkit-tap-highlight-color:transparent] active:border-amber active:text-amber"
          >
          ...
          <a
            ...
            onClick={close}
            className="flex-1 flex items-center justify-center gap-2 h-[52px] border border-[rgba(76,175,114,0.3)] text-[#4caf72] text-[13.5px] font-semibold tracking-[-0.01em] [-webkit-tap-highlight-color:transparent] active:border-amber active:text-amber"
          >
        ...
        <a
          href="#contacto"
          onClick={close}
          className={`flex items-center justify-center h-[60px] bg-amber text-ink font-bold text-[15px] tracking-[0.06em] uppercase mt-[14px] [-webkit-tap-highlight-color:transparent] active:bg-amber-2 transition-[background-color,transform] duration-[380ms] ease-[cubic-bezier(0.16,1,0.3,1)] delay-[140ms] ${open ? 'translate-y-0' : 'translate-y-3'}`}
        >
          Cotizar ahora →
        </a>
      </div>

      <div className="hidden max-[760px]:flex fixed bottom-0 left-0 right-0 z-[150] bg-ink-2 border-t border-line-2 px-[22px] pt-3 pb-[calc(12px+env(safe-area-inset-bottom,0px))] gap-3 items-center">
        <a
          href="tel:+541148150099"
          className="w-[52px] h-[52px] border border-line-2 flex items-center justify-center text-cream shrink-0 transition-[border-color,color] [-webkit-tap-highlight-color:transparent] active:border-amber active:text-amber"
          aria-label="Llamar"
        >
        ...
        <a
          href="#contacto"
          className="flex-1 bg-amber text-ink flex items-center justify-center h-[52px] font-bold text-[14px] tracking-[0.06em] uppercase transition-colors [-webkit-tap-highlight-color:transparent] active:bg-amber-2"
        >
          Cotizar ahora →
        </a>
      </div>
