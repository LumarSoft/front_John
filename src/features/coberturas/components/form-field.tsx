...
export function FormField({ field }: { field: Field }) {
  const inputClass =
    'bg-paper border border-line-2 text-ink font-sans text-[14.5px] px-4 py-[12px] outline-none transition-[border-color,box-shadow] duration-[180ms] appearance-none w-full rounded-2xl focus:border-ember focus:shadow-[0_0_0_3px_rgba(232,168,32,0.12)] placeholder:text-faint'
